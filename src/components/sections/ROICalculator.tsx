    ...
    <section className="py-24 relative bg-[#04080e] overflow-hidden border-t border-cyan-900/40">
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16">
          {/* Controls */}
          <FadeUp delay={0.1} className="lg:w-1/2">
            <div className="p-8 rounded-2xl ios-liquid-glass border border-cyan-800/30 shadow-[0_0_30px_rgba(0,212,255,0.05)]">
              <h3 className="text-2xl font-bold text-cyan-50 mb-8 font-syne">
                {t("current_metrics")}
              </h3>
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full accent-[#00D4FF] h-2 bg-cyan-950 rounded-lg appearance-none cursor-pointer"
                  />
                </div>
          ...
          {/* Results Analysis */}
          <FadeUp delay={0.25} className="lg:w-1/2 flex flex-col justify-center">
            <div className="p-8 rounded-2xl bg-gradient-to-br from-cyan-900/40 to-[#070b12] border border-[#00D4FF]/20 relative overflow-hidden">
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                ...
                <div className="p-4 rounded-xl bg-cyan-900/40 border border-[#00D4FF]/30 shadow-[0_0_15px_rgba(0,212,255,0.15)] relative">
                  <div className="absolute -top-3 -right-3 bg-[#00D4FF] text-[#020408] text-[10px] font-bold px-2 py-1 rounded-full animate-bounce">
                    {t("estimated")}
                  </div>
                  <p className="text-xs text-cyan-200/70 uppercase tracking-widest mb-1">
                    {t("new_revenue")}
                  </p>
              ...
              <div className="border-t border-cyan-800/40 pt-6">
                <p className="text-sm text-cyan-100/60 mb-1">
                  {t("extra_profit")}
                </p>
                <div className="flex items-baseline gap-2 text-green-400">
                  <span className="text-5xl font-black tracking-tighter text-glow">
                    +${revenueIncrease.toLocaleString()}
                  </span>
                  <span className="text-lg font-medium">{t("per_month")}</span>
                </div>
                <p className="text-xs text-green-400/60 mt-2 italic">
                  {t("per_year", {
                    yearly:
                      "$" + Number(revenueIncrease * 12).toLocaleString(),
                  })}
                </p>
              </div>
            </div>
